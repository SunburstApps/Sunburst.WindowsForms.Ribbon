...
namespace Sunburst.WindowsForms.Ribbon.Controls.Properties
{
    /// <summary>
    ...
    public class FontControlPropertiesProvider : BasePropertiesProvider, IFontControlPropertiesProvider
    {
        ...
        public FontProperties Bold 
        {
            get
            {
                ...
                return _bold.GetValueOrDefault(Interop.FontProperties.NotAvailable);
            }
            set
            {
                _bold = value;
        ...
        public FontProperties Italic 
        {
            get
            {
                ...
                return _italic.GetValueOrDefault(Interop.FontProperties.NotAvailable);
            }
            set
            {
                _italic = value;
        ...
        public FontProperties Strikethrough 
        {
            get
            {
                ...
                return _strikethrough.GetValueOrDefault(Interop.FontProperties.NotAvailable);
            }
            set
            {
